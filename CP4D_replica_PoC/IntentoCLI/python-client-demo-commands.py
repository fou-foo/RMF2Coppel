...
#e.g
CloudPakforData_HOSTNAME = "spark301-cpd-spark301.apps.cp4dperf8.demo.ibmcloud.com"
USER = "admin"
PASSWORD = "password"
SPARK_INSTANCE = "spark-instance-ws3"
SPARK_INSTANCE_HOME_VOLUME = "spark-instance-ws3-vol"
APP_VOLUME_INSTANCE = "app-vol2"
...
volume_instance_payload = {
	"metadata": {
		"storageClass": "managed-nfs-storage", # con esta clase de almacenamiento hay pedos creando los volumenes
		"storageSize": "20Gi"
	},
	"resources": {},
