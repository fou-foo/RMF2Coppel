WITH "MATCH (lat_civil:EDO_CIVIL{edocivil:\""+$edociv+"\"}),(lat_entidad:ESTADO{D_EDO:"+$entidad+"}),(lat_gen:GENERO{genero:\""+$gen+"\"}) CALL gds.pageRank.stream('graforecoconexo_con_compras', {
  maxIterations: 20,
  dampingFactor: 0.85,
  tolerance: 0.01,
  relationshipTypes:['COMPRO_CLASE','EDO_SIMILITUD','PODRIA_INTERESARLE'],
  relationshipWeightProperty: 'peso',
  sourceNodes: [lat_civil,lat_entidad]})
YIELD nodeId, score
